...
class ChangeOrderJController extends AdminController
{
    /**
    ...
    protected function grid()
    {
        ...
        $grid->model()->where('type',13)->orderByDesc('id');
        $grid->disableCreateButton();

//        $grid->export(function ($export) {
//
//            $export->filename('会员信息修改列表'.date(Y-m-d).'.csv');
//
//        });
